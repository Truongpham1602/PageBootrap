  ...
  return (
    <>
      <div className="navbar navbar-expand-lg member-logo">
        ...
        <div
          className="offcanvas offcanvas-end text-bg-dark row"
          tabIndex="-1"
          id="offcanvasDarkNavbar"
          aria-labelledby="offcanvasDarkNavbarLabel"
        >
          <div className="sb-nav-fixed col-4">
                      ...
                      <div className="Dashboards">
                        ...
                        <div className="menu-item pt-1">
                          ...
                          <div className="menu-content">
                            <span className="menu-heading fw-bold text-uppercase">
                              Pages
                            </span>
                          </div>
                          {/* end:Menu content */}
